...
class CreateOrderApiRequestMapperTest {
    ...
    fun `map CreateOrderApiRequest to CreateOrderApiRequestV1`() {
        ...
        val expectedRequestV1: CreateOrderApiRequestV2 = CreateOrderApiRequestFactory.buildCreateOrderApiRequestV1()

        val result: CreateOrderApiRequestV2 = createOrderApiRequestMapper.toRequestV1(apiRequest)
